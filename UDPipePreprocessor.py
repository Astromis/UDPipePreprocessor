...
#class UDPipePreprocessor:
#    def __init__(text_field="text", doc_field="doc", memoize=True)
...
from snorkel.preprocess.core import BasePreprocessor, Preprocessor

#EN_CORE_WEB_SM = "en_core_web_sm"


class UDPipePreprocessor(Preprocessor):
    ...
    def __init__(
        ...
        text_field: str,
        doc_field: str,
        udpipe_model_path: str = "./udpipe/models/rus_model.udpipe",
        ...
        self._udpipe = TextParser("./snorkel_add/udpipe/models/rus_model.udpipe")
    ...
    def run(self, text: str) -> FieldMap:  # type: ignore
        ...
        return dict(doc=self._udpipe.parse(text))
